...
<?php foreach ($barang as $key => $value) { ?>
              ...
              <div class="card bg-light">
                ...
                <div class="card-footer">
                  ...
                  <div class="col-sm-6">
                    <div class="text-left">
                    <span class="badge bg-gray"><i class="fas fa-tags"></i> Rp. <?= number_format($value->harga, 0) ?></span>
                    </div>
                  </div>
                  <div class="col-sm-6">
                  <div class="text-right">
                    <a href="<?= base_url('home/detail_barang/'. $value->id_barang)?>" class="btn btn-sm bg-warning ">
...
<?php } ?>
  ...
  $(function() {
    ...
    $('.swalDefaultSuccess').click(function() {
      Toast.fire({
        icon: 'success',
        title: 'Sukses Menambahkan Barang Ke Dalam Keranjang'
      })
    });
  });
    </script>