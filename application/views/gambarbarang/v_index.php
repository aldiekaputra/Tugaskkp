            ...
            <div class="card card-primary">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="<?=base_url('barang/add')?>" type="button" class="btn btn-primary btn-sn" ><i class="fas fa-plus "></i>Add</a>
                </div>
                <!-- /.card-tools -->
              </div>
              <!-- /.card-header -->
                ...
                <table class='table table-bordered' id="example1">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center"><span class="badge bg-primary"><h5><?= $value->total_gambar?></h4></span></td>
