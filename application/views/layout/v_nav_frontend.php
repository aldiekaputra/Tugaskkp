    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            <a id="dropdownSubMenu1" href="<?= base_url('kategori')?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Kategori</a>
      ...
      <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
        ...
        <a class="nav-link" data-toggle="dropdown" href="#">
          ...
          <img src="<?= base_url()?>template/dist/img/user1-128x128.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-4"
             style="opacity: .8">
        ...
        <?php $keranjang = $this->cart->contents(); $jml_item = 0;
        foreach ($keranjang as $key => $value) {$jml_item = $jml_item+$value['qty'] ;}
        ?>
        <li class="nav-item dropdown">
          <a class="nav-link" data-toggle="dropdown" href="#">
